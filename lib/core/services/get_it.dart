...
import 'package:fruit_app_dashboard/core/services/firebase_storage_service.dart';
...
void setupGetIt() {
  ...
  getit.registerLazySingleton<DataBaseServices>(() => FirebaseStorageServices());
  ...
  getit.registerLazySingleton<OrderRepo>(
    () => OrderRepoImpl(getit.get<DataBaseServices>()),
  );
}
